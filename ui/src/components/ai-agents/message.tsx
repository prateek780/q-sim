...
export function Message({ message, agents }: any) {
    ...
    return (
        <div
            className={`flex gap-3 mb-4 ${message.role === "user" ? "flex-row-reverse" : message.role === "system" ? "justify-center" : ""
                }`}
        >
            ...
            >
                ...
                <div className="text-sm whitespace-pre-wrap">
                    {message.content.split(/(@[A-Za-z\s-]+)/).map((part: any, index: any) => {
