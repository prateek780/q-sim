...
OUTPUT_EXAMPLE ={
  ...
  "optimization_steps": [
    {
      "change": "Added direct classical link 'L-CR2-CR4-REDUNDANT' between ClassicalRouter-2 (in Network-2) and ClassicalRouter-4 (in Network-3).",
    ...
    {
        "change": "No changes made to quantum network links or adapters.",
...
EXAMPLES = [
    {
        "input": OptimizeTopologyRequest(**{
            'world_id': '01JSMD3F6SZF664Y71V5Z5DCKG',
            'optional_instructions': None
        }),
        "extra_info": f"Sample world used for this example: {WorldModal(**OUTPUT_EXAMPLE).model_dump_json()}",
